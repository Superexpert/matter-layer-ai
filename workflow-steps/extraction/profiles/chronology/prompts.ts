...
export function buildChronologyUserPrompt(window: ChronologyMarkdownWindow) {
  return [
    ...
    "{\"facts\":[{\"date\":\"YYYY-MM-DD|null\",\"dateText\":\"source date text|null\",\"timeText\":\"source time text|null\",\"summary\":\"what happened\",\"people\":[\"person names\"],\"organizations\":[\"organization names\"],\"sourceDocumentId\":\"...\",\"sourceFileName\":\"...\",\"sourcePages\":[1],\"sourceQuote\":\"exact supporting quote\",\"confidence\":\"high|medium|low|unknown\",\"labels\":[\"optional natural-language labels\"]}]}",
    ...
    "- timeText: the original time wording when available; otherwise null.",
